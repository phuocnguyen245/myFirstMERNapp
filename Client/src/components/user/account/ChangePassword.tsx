      ...
      swalWithBootstrapButtons
        ...
        .then((result) => {
          if (result.isConfirmed) {
            swalWithBootstrapButtons.fire('Re-direct to Login', 'success');
            ...
            swalWithBootstrapButtons.fire('Cancelled', 'Enjoy your time', 'success');
          }
        });
              ...
              <div className="main__left col-8">
                ...
                <div className="left__top">
                  <div className="mb-3 row">
                    <label htmlFor="oldPassword" className="col-form-label text-right">
                      Old Password
                    </label>
                  ...
                  <div className="mb-3 row">
                    <label htmlFor="Password" className="col-form-label text-right">
                      Password
                    </label>
                    <div className="col-sm-8" style={{ flex: '1', maxWidth: '100%' }}>
                      <input
                  ...
                  <div className="mb-3 row">
                    <label htmlFor="confirmPassword" className="col-form-label text-right">
                      Confirm
                    </label>
                    <div className="col-sm-8" style={{ flex: '1', maxWidth: '100%' }}>
                      <input
