            ...
            <div className="main__left col-8">
              <div className="left__top">
                <div className="mb-3 row">
                  <label htmlFor="username" className="col-form-label text-right text-right">
                    Username
                  </label>
                ...
                <div className="mb-3 row">
                  <label htmlFor="tel" className="col-form-label text-right">
                    Tel
                  </label>
                  <div className="col-sm-8" style={{ flex: '1', maxWidth: '100%' }}>
                    <input
