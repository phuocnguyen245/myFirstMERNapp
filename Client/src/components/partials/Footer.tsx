        ...
        <div className="row">
          ...
          <div className="footer-col col-md-6 col-sm-6 col-xl-2 p-0">
            ...
            <ul>
              ...
              <li>
                <a href="/#">
                  <img src="/assets/img/Huawei-gallery-vn.png" alt="" />
                </a>
              </li>
            </ul>
          </div>
          <div className="footer-col col-md-6 col-sm-6 col-xl-2 p-0">
            <ul>
              <li>
                <img src="/assets/img/Logo-ShopeefoodVN.png" alt="" />
              </li>
          ...
          <div className="footer-col col-md-6 col-sm-6 col-xl-5 p-0">
            ...
            <ul>
              ...
              <li>Giấy CN ĐKDN số: 0311828036</li>
              <li>do Sở Kế hoạch và Đầu tư TP.HCM cấp ngày 11/6/2012,</li>
              <li>sửa đổi lần thứ 23, ngày 10/12/2020</li>
              <li>Số điện thoại: 1900 2042</li>
              <li>Email: info@shopeefood.vn</li>
              <li>
                <img src="/assets/img/gov_seals1.jpg" alt="" />
              </li>
            </ul>
          </div>
        </div>
