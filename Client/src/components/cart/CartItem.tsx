...
function CartItem({
      ...
      swalWithBootstrapButtons
        ...
        .then((result) => {
          if (result.isConfirmed) {
            ...
            swalWithBootstrapButtons.fire('Deleted!', 'Cart Item has been deleted.', 'success');
  ...
  const handleCheck = (product_ID: string) => {
    setCheck(!check);
    if (counter === 0) {
  ...
  return (
    <div className="cart-item d-flex justify-content-between align-items-center">
      <div className="product-left d-flex justify-content-between align-items-center">
        <input type="checkbox" checked={check} onChange={() => handleCheck(product_ID)} />
      ...
      <div className="product-mid">
        ...
        <div className="item_btn d-flex justify-content-start align-items-center">
          ...
          <div className="btn__delete" onClick={() => handleDelete()}>
            <IoTrashOutline />
          </div>
        </div>
      </div>
